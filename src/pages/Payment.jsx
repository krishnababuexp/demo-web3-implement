...
export default function Payment() {
    ...
    return (
        ...
        <RootLayout>
            <h1 className="text-2xl text-center font-bold">Payment Page</h1>
            <div className="flex items-center justify-center min-h-screen bg-gray-50 dark:bg-neutral-950 px-4">
